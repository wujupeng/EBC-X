...
[![Tasks](https://img.shields.io/badge/EV0-TASKS-v1.2%20HARDENED-yellow)]()
...
| **任务规划** | [`.codeartsdoer/specs/ebcx_ev0_arch/tasks.md`](.codeartsdoer/specs/ebcx_ev0_arch/tasks.md) | 🟡 v1.2 HARDENED | 60 个任务，EV1(25) + EV2(17) + EV3~EV12(10) + 集成/部署/评审(8)，TASK-H01~H13 加固 |
